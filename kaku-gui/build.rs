...
BEGIN
    ...
    BEGIN
        ...
        BEGIN
            ...
            VALUE "FileDescription",  "Pack - A fast terminal for AI coding\\0"
            VALUE "FileVersion",      "{version}\\0"
            VALUE "LegalCopyright",   "Tw93, MIT licensed\\0"
            VALUE "InternalName",     "\\0"
            VALUE "OriginalFilename", "\\0"
            VALUE "ProductName",      "Pack\\0"
...
"#,
    ...
    #[cfg(target_os = "macos")]
    {
        ...
        println!("cargo:rerun-if-changed=assets/macos/Desk.app/Contents/Info.plist");
